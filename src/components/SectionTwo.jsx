            ...
            <section>
                <Container>
                    <div className='text-center ' data-aos="fade-down">
                        <h2 className=' ff_poppins fw-semibold fs_18 fst-normal color_282 pt-5 mt-3'>Top Selling</h2>
                    ...
                    <Col xl={11} className='mx-auto'>
                        <Row className=" mb-5 justify-content-center ">
                            <Col xs={10} sm={6} md={5} xl={4} className='px-sm-4' data-aos="flip-right">
                            ...
                            <Col xs={10} sm={6} md={5} xl={4} className='px-sm-4 my-5 mt-sm-0' data-aos="flip-right">
                                <div className='Card_2 position-relative c_pointer'>
                                    <div className='overflow-hidden border_redius_trip'>
