...
const SectionSix = () => {
  return (
    <>
      <section>
        <Container className="container pt-5" data-aos="zoom-in">
          <div className='email_full_box my-5 position-relative'>
            ...
            <img className='position-absolute Circel1 w-40' src={Circel1} alt="" />
            <img className='position-absolute Circel2 w-40' src={Circel2} alt="" />
