                ...
                <div className='container'>
                    <div className='row align-items-center pb-5 mb-5'>
                        <div className="col-lg-6 col-12 pt-5 ">
                            ...
                            <h1 className=' ff_volkhov fs_84 fw-bold fst-normal color_E4B pt-4'>Travel, <span className='down_line_enjoy position-relative'>enjoy</span> and live a new and full life</h1>
